...
RSpec.describe Invoice, type: :model do
  ...
  describe 'instance methods' do 
    ...
    it 'returns the total, non-discounted revenue from an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Barney", created_at: Time.now, updated_at: Time.now)
    ...
    it 'returns the total, discounted revenue for an item on an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Barney", created_at: Time.now, updated_at: Time.now)
      ...
      expect(invoice_1.item_discounted_revenue(item_1.id)[0].total).to eq(28800)
    end
    
    it 'returns the total discounted revenue an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Barney", created_at: Time.now, updated_at: Time.now)
      ...
      expect(invoice_1.items_discounted_revenue_total).to eq(151800)
    end

    it 'returns the total discounted revenue of the items for a merchant on an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Barney", created_at: Time.now, updated_at: Time.now)
      ...
      expect(invoice_1.items_discounted_revenue_total).to eq(76800)
    end
