...
RSpec.describe Invoice, type: :model do
  ...
  describe 'instance methods' do 
    ...
    it 'returns the discounted total for an invoice' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Barney", created_at: Time.now, updated_at: Time.now)
      ...
      discount3 = Discount.create!(percent: 10, quantity_threshold: 15, merchant_id: merchant_2.id)

      expect(invoice_1.discount_total).to eq(26700)
    end

     it 'returns the discounted total for an invoice - for only a specific merchant' do 
      merchant_1 = Merchant.create!(name: "Schroeder-Jerde", created_at: Time.now, updated_at: Time.now)
      merchant_2 = Merchant.create!(name: "Barney", created_at: Time.now, updated_at: Time.now)
      ...
      discount1 = Discount.create!(percent: 10, quantity_threshold: 5, merchant_id: merchant_1.id)
      discount2 = Discount.create!(percent: 20, quantity_threshold: 10, merchant_id: merchant_1.id)
      discount3 = Discount.create!(percent: 10, quantity_threshold: 15, merchant_id: merchant_1.id)

      expect(invoice_1.discount_total_merchant(merchant_1)).to eq(19200)
    end
